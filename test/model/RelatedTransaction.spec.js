...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rosetta.RelatedTransaction();
  });
  ...
  describe('RelatedTransaction', function() {
    it('should create an instance of RelatedTransaction', function() {
      ...
      //var instane = new Rosetta.RelatedTransaction();
      //expect(instance).to.be.a(Rosetta.RelatedTransaction);
    });
    ...
    it('should have the property networkIdentifier (base name: "network_identifier")', function() {
      ...
      //var instance = new Rosetta.RelatedTransaction();
