...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rosetta.BlockTransaction();
  });
  ...
  describe('BlockTransaction', function() {
    it('should create an instance of BlockTransaction', function() {
      ...
      //var instane = new Rosetta.BlockTransaction();
      //expect(instance).to.be.a(Rosetta.BlockTransaction);
    });
    ...
    it('should have the property blockIdentifier (base name: "block_identifier")', function() {
      ...
      //var instance = new Rosetta.BlockTransaction();
